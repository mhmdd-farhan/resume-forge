...
//   2. NEXT_PUBLIC_APP_URL (fallback)  - legacy Next.js client-visible name
...
export const APP_URL = env.NEXT_APP_URL || env.NEXT_PUBLIC_APP_URL || SITE_URL;
...
export const CONFIGURED_APP_URL =
	env.NEXT_APP_URL || env.NEXT_PUBLIC_APP_URL || '';